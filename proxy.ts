...
import { isPublicPath, RATE_LIMIT_EXEMPT_API_PATHS } from '@/src/infrastructure/http/routeAccess'
...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon.ico|sw\\.js|manifest\\.json|robots\\.txt|sitemap\\.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)'],
}
