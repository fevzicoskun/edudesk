        ...
        <form action={nameAction} className="mb-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              required
              className="flex-1 px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg text-base bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button
              type="submit"
