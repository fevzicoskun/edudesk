...
export default function AnasayfaLoading() {
  return (
    <div className="p-4 md:p-6 max-w-6xl mx-auto">
      ...
      {/* 2 kolon: takip listesi + sınıf özeti */}
      ...
      {/* 3 kolon: bugün/yaklaşan + takvim */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl p-4 space-y-3">
