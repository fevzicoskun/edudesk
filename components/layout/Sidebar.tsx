...
const navItems: { href: string; label: string; mobile: boolean; roles: Role[] | null; icon: React.ReactNode; subItems?: { href: string; label: string; mentorOnly?: boolean }[] }[] = [
  ...
  },
  {
    ...
    subItems: [{ href: '/toplantilar', label: 'Toplantı Kayıtları' }],
  },
  {
    href: '/odevler',
    label: 'Ödevler',
      ...
      <aside className="hidden md:flex w-60 bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-700 flex-col shrink-0">
        ...
        <div className="p-3 border-t border-gray-200 dark:border-slate-700">
          ...
          <div className="flex items-center gap-1">
            ...
            <Link
              href="/yardim"
              className="w-9 h-9 flex items-center justify-center rounded-lg text-gray-400 dark:text-slate-500 hover:bg-gray-100 dark:hover:bg-slate-800 hover:text-gray-600 dark:hover:text-slate-300 transition-colors shrink-0"
              title="Yardım"
            >
