  ...
  return (
    <header className="hidden md:flex items-center justify-end gap-4 h-16 shrink-0 px-6 bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-slate-700">
      <button
        ...
        onClick={openSearch}
        title="Ara (Ctrl+K)"
        className="group flex items-center gap-3 w-80 max-w-full px-4 py-2.5 rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-800/60 text-gray-400 dark:text-slate-500 hover:border-gray-300 dark:hover:border-slate-600 transition-colors"
      >
