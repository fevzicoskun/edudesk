  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {unread > 0 && (
          <span className="absolute top-1 right-1 min-w-[16px] h-4 bg-red-600 text-white text-[10px] font-bold rounded-full flex items-center justify-center px-0.5 leading-none">
            {unread > 9 ? '9+' : unread}
          </span>
        )}
      </button>
          ...
          <div className="max-h-[400px] overflow-y-auto">
            {!loaded ? (
              ...
              <div className="px-4 py-10 flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-xs text-gray-500 dark:text-slate-400">Ödev güncellemeleri ve önemli gelişmeler burada görünür.</p>
              </div>
            ) : (
